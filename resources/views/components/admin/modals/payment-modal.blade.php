                ...
                <form action="{{ route('admin.transactions.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="metode-pembayaran" class="form-control form-control-lg" id="metode-pembayaran"
                                required>
                        ...
                        <div class="form-group" id="upload-bukti-wrapper" style="display: none;">
                            <label for="bukti-transfer">Upload Bukti Pembayaran</label>
                            <input type="file" name="upload_bukti" id="bukti-transfer" class="form-control-file">
                        </div>
                        ...
                        <div class="kembalianinfo">
                            <h4>Kembalian : <span id="kembalian"></span></h4>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <button type="submit" id="btn-simpan" class="btn btn-success">Bayar</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    @push('js')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const uploadBukti = document.getElementById('upload-bukti-wrapper');
                const inputBayar = document.getElementById('input-bayar');
                const totalHarga = document.getElementById('total-harga');
                const kembalianinfo = document.querySelector('.kembalianinfo');
                ...
                metodePembayaran.addEventListener('change', function() {
                    ...
                    if (selected === 'transfer') {
                        ...
                        inputBayar.value = totalHarga.value;
